...
import numpy as np
import ATN.util.net_element as ne
...
class BasicCnn:
    ...
    def __init__(self, data, groundtruth, p_keep):
        self.data = tf.reshape(data, [-1, 32, 32, 1])
    ...
    def weights(self):
        _weights = {
            ...
            'W_fc1': ne.weight_variable([8 * 8 * 64, 1024], name='W_fc1'),
            'W_fc2': ne.weight_variable([1024, 25], name='W_fc2')
        }
        return _weights
    ...
    def biases(self):
        _biases = {
            ...
            'b_fc2': ne.bias_variable([25], name='b_fc2')
        }
        return _biases
    ...
    def prediction(self):
        ...
        # print('shape of maxpool1 :',np.shape(h_pool1))
        h_conv2 = tf.nn.relu(
            ne.conv2d(
        ...
        # print('shape of maxpool2 :',np.shape(h_pool2))
